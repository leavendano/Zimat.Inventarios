  ...
  : IQueryHandler<GetArticuloQuery, Result<ArticuloDTO>>
{
  public async Task<Result<ArticuloDTO>> Handle(GetArticuloQuery request, CancellationToken cancellationToken)
  {
    ...
    return new ArticuloDTO(entity.Id,entity.Clave, entity.Descripcion, entity.PrecioPublico,entity.CostoUnitario,
          entity.Impuesto1, entity.UnidadId,entity.RutaImagen);
  }
}
