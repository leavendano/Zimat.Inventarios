...
public class CompraConcepto : EntityBase<Guid>, IRegisterBase
{
  ...
  public CompraConcepto(Guid compraId, Guid articuloId, decimal precio, decimal costo, decimal cantidad, decimal impuesto1)
  {
    CompraId = Guard.Against.Null(compraId, nameof(compraId));
